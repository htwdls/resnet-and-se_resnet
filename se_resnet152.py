# -*- coding: utf-8 -*-
"""
Created on Wed Nov 21 16:42:22 2018
...
def inference(features, one_hot_labels):
    ...
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='a_2')
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='b_2')
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='c_2')
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='d_2')
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='e_2')
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='f_2')
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='g_2')
    x = identity_block(x, 3, [256, 256, 1024], stage=4, block='h_2')
    #stage5#
